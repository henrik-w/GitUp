...
- (NSView*)tableView:(NSTableView*)tableView viewForTableColumn:(NSTableColumn*)tableColumn row:(NSInteger)row {
  ...
  if (row % 2) {
    if (data.diffView) {
      ...
      view.openButton.tag = (NSInteger)data;
      view.mergeButton.tag = (NSInteger)data;
      view.resolveButton.tag = (NSInteger)data;
      return view;
  ...
  view.menuButton.tag = (NSInteger)data;
  ...
  view.actionButton.tag = (NSInteger)data;
  return view;
}
